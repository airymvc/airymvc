...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="webroot/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<!-- InstanceBeginEditable name="doctitle" -->
<title>會員註冊</title>
<!-- InstanceEndEditable -->
<link  rel="stylesheet" type="text/css" href="webroot/css/modle.css"/>
...
<div class="wrapper">
<div class="header">
	<div class="logobox"><a href="index.html">LOGO</a></div>
</div>
<!-- header end -->
<div class="container">
<div class="main_nav">
...
搜尋
<select name=""><option>1999</option><option>1998</option><option>1997</option><option>1996</option><option>1995</option></select>年
<select name=""><option>01</option><option>02</option><option>03</option><option>04</option><option>05</option></select>月
<select name=""><option>22</option><option>23</option><option>24</option><option>25</option><option>26</option></select>日
<a href="searchlist.html" title="搜尋"><input name="search" type="button" value=" 搜尋 " /></a>
</div>
...
<div class="rightsider">
    <div class="rightlistbox">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           ...
           <tr>
            ...
            <td ><input name="" type="text" size="7" /><img src="webroot/img/AE86.jpg" />
           ...
           <tr>
           	<td align="center" colspan="2">
            	<div class="loginlink">
                    <a href="join.html" title="加入會員">加入會員</a>  |   
                    <a href="forget.html" title="忘記密碼">忘記密碼</a>  | 
                    <a href="memberin.html" title="登入">登入</a>
                </div> 
             </td>
     	   </tr>  
        </table>
        ...
        <div class="adroom">
        	<a href="http://www.google.com" target="_blank" title=""><img src="webroot/img/2012-03-01_154537__199.jpg" width="250" height="250" alt="" /></a>
        </div>
        <div class="tagroom">
...
<h3 class="titlebar">會員註冊</h3>
<div class="editroom2">
<form at="http://<?php echo $server_host?>/index.php?cl=memberInfo&at=add" method ="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
 <tr>
    <td align="right" width="15%">*帳號：</td>
    <td>
   	<input name="account_id" type="text" size="30" /><b class="small">(E-mail)</b>
    </td>
  </tr>
   <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td> 
       <input name="birthday" type="date" size="20" /> <b class="small">(YYYY-MM-DD)</b>
    </td>
  </tr>
  <tr>
  ...
  <td><input name="tel" type="text" size="2" /> 
  </td>
  </tr>
  <tr>
  	<td align="right">連絡地址：</td>
    <td><input name="address" type="text" size="70" /></td>
  </tr>
  <tr>
    <td colspan="2" align="center">
    <hr  class="hrclocr"/>
   <!-- <input type="button" onclick="MM_popupMsg('恭喜加入會員')" value="送出" /> -->
    <input name="input" value="确认"  type="submit"/>
    </td>
  </tr> 
</table>
</form>
...
<!-- container end -->
<div class="footer">
<p>Copyright © 2012 史上今本日All Rights Reserved. 版權所有</p>
</div>
<!-- footer end -->
</div>
<!-- wrapper end -->
