...
<div class="editroom2">
    <form action="<?php echo $httpServerHost;?>/index.php?cl=memberInfo&at=updateChange&id=<?php echo $id;?>&name=<?php echo $cname; ?>" method="post">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input name="datepicker" type="text" value="<?php echo $rows['birthday']; ?>" size="20" /></td>
  </tr>
  <tr>
