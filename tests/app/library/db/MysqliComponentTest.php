 ...
 */
class MysqliComponentTest extends AiryUnitTest {
    ...
    public function testSetUp() {
    	$this->object = new MysqlComponent(0);
...
//		$mysqli->close();
    ...
    public function testInnerJoin() {		
		...
		$result = $this->object->innerJoin($tables)->getJoinPart();		
    ...
    public function testJoinOn1() {	
		...
		$result = $this->object->joinOn($condition)->getJoinOnPart();		
