...
<!--右方內容區塊-->
            <div class="SidebarRight">
                <div class="Index"><a href="">會員管理</a>_查看修改</div>
                <div class="Content">
                    <?php $rows = mysql_fetch_array($mysql_results, MYSQL_BOTH); ?>
                    <form action="<?php echo $httpServerHost;?>/index.php?md=backend&cl=member&at=update&id=<?php echo $rows[0];?>&page=<?php echo $page; ?>&number_page=<?php echo $number_page;?>" method ="post">
                    <table class="TableA">
                        <tbody>
						<tr>
